...
public class Locker {
	...
	public Locker(Main main, Location loc) {
		this.main = main;
		lockerFile = new File(main.getDataFolder() + "/" + main.locationToString(loc) + ".yml");
		checkLockerFile();
		reloadLockerFile();
		location = loc;
	...
	public Locker(Main main, Location loc, UUID owner) {
		this.main = main;
		lockerFile = new File(main.getDataFolder() + "/" + main.locationToString(loc) + ".yml");
		checkLockerFile();
		reloadLockerFile();
